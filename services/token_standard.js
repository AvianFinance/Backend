...
async function get_standard(token_type) { // token_type shout be ERC721 or ERC4907
    ...
    if (token_type=="ERC721"){
        console.log("choosing the erc721 standard")
        ...
        console.log("choosing the erc4907 standard")
...
async function get_signer(condition) { 
    ...
    const ethProvider = new ethers.providers.JsonRpcProvider("https://goerli.infura.io/v3/306c106577824785a447b6398a50916e")
    const signer_m = new ethers.Wallet("7e0dd21cba3952c769b9a90376893a351d4ac356aeacd0e537f5022e08593528", ethProvider); // Meelan Credentials
    const signer_r = new ethers.Wallet("2f3b47319ba27e3e58ae7a62ecb3966b23b9df1b8a12d1b7520f643a6d7fdc33", ethProvider); // Rosy credentials
    const signer_i = new ethers.Wallet("986815db062b75efa84cd38ea93e08e9e13a42ee9493f756c1bc661d06201e68", ethProvider); // Meelan Credentials
